...
UNZIP_DISABLE_ZIPBOMB_DETECTION=TRUE unzip modulus_datasets-cardiovascular-simulation_0.0.zip
UNZIP_DISABLE_ZIPBOMB_DETECTION=TRUE unzip cardiovascular_dataset.zip
